...
public class ExtentReportManager {
    ...
    public static synchronized ExtentTest stratTest(String testcasename, String testcasedesscription) {
    	ExtentReportManager.test = ExtentReportManager.reports.startTest(testcasename, testcasedesscription);
